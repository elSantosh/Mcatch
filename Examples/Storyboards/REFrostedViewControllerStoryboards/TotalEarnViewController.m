...
#import "TotalEarnTableViewCell.h"

#import "SVProgressHUD.h"

@interface TotalEarnViewController ()  <UITableViewDataSource,UITableViewDelegate>


@end

@implementation TotalEarnViewController
@synthesize result;
...
- (void)viewDidLoad {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSString *urlString = [NSString stringWithFormat:@"http://mobilemcatch.mcommsg.com/PublisherTotalEarn.aspx?publisherid=%@",accID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    static NSString *MyIdentifier = @"totalearncell";
    TotalEarnTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:MyIdentifier];
